...
import it.pkg.infra.model.Filter;
import it.pkg.model.Car;
import it.pkg.service.CarService;
...
import static it.pkg.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                it.pkg.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? it.pkg.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? it.pkg.infra.model.SortOrder.DESCENDING
                            : it.pkg.infra.model.SortOrder.UNSORTED;
                }
